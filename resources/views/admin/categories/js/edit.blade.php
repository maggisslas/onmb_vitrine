<script>
    ...
    function editCategory(category_id , name , description , pictureUrl){

        var route = "{{ route('admin.categories.update' , ':id') }}"
        ...
        $('#updateModal form #name').val(name)
        $('#updateModal form #description').val(description)
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    $('#category-update-form')[0].reset(); // Réinitialiser le formulaire
