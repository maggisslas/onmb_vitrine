...
<script>
    ...
    initFileUploader("picture", "dropZone", "pictureList" , 382 , 257 , action_reset);
    initFileUploader("pictureSup", "dropZoneSup", "pictureSupList" , 794 , 435 , action_reset , 'error-message-sup');

    initFileUploader("pictureUpdate", "dropZoneUpdate", "pictureListUpdate" , 382 , 257, action_reset);
    initFileUploader("pictureSupUpdate", "dropZoneSupUpdate", "pictureSupUpdateList" , 794 , 435, action_reset);


    $('#immobilier-form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    $('#addModal').modal('hide')
                    $('#immobilier-form')[0].reset(); // Réinitialiser le formulaire
