...
<script>
    ...
    initFileUploader("picture", "dropZone", "pictureList" , 824 , 450 , action_reset);
    initFileUploader("pictureSup", "dropZoneSup", "pictureSupList" , 794 , 435 , action_reset , 'error-message-sup');

    initFileUploader("pictureUpdate", "dropZoneUpdate", "pictureListUpdate" , 824 , 450, action_reset);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    $('#addModal').modal('hide')
                    $('#article-form')[0].reset(); // Réinitialiser le formulaire
